...
class MainFrame(ctk.CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        self.label2.place(relx=0.5, rely=0.525, anchor='center')
        ...
        self.button1.place(relx=0.5, rely=0.60, anchor='center')
        ...
        self.button2.place(relx=0.5, rely=0.70, anchor='center')