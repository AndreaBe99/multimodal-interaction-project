...
class EyeAspectRatio:
    ...
    def get_ear(self, refer_idxs, landmarks) -> typing.Tuple[float, list]:
        """
    ...
    def calculate_avg_ear(self, landmarks)-> typing.Tuple[float, tuple]:
        """
        ...
        """
        left_ear, left_lm_coordinates = self.get_ear(self.left_eye_idxs, landmarks)
        right_ear, right_lm_coordinates = self.get_ear(self.right_eye_idxs, landmarks)
